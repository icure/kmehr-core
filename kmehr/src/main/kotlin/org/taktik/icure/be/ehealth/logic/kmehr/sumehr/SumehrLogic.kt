...
interface SumehrLogic {
     ...
     * @return a SumEHR status: uptodate if the signatures match, outdated otherwise
     */
     ...
     * HealthElements retrieved are the ones related to the HCP passed as paramater and to the Patients whose Secret
     ...
     * @param mappings
     * @param saveToDatabase whether to save the new HCP and Patients to the datababase
