...
class ParagraphDAOImpl(couchDbProperties: CouchDbProperties, @Qualifier("drugCouchDbDispatcher") couchDbDispatcher: CouchDbDispatcher, idGenerator: IDGenerator, val ampDAO: AmpDAO) :
	...
	override fun findParagraphsWithCnk(cnk: Long, language: String): Flow<Paragraph> = flow {
		...
		val viewQuery = createQuery<Paragraph>("by_chapter_paragraph")
